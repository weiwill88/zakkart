...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'orders', name: 'OrderGenerator', component: () => import('../views/system/ComingSoonView.vue'), meta: { title: '订单生成', menu: true, icon: '📝', phase: '阶段 2', description: '下单生成、BOM 拆解和草稿合同生成会在阶段 2 与合同模块一起正式接入。当前原型数据已下线，避免干扰验收。' } },
