...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'part-types', name: 'PartTypeList', component: () => import('../views/parts/PartTypeList.vue'), meta: { title: '配件管理', menu: true, icon: '🧩' } },
      ...
      { path: 'shipments', name: 'ShipmentList', component: () => import('../views/shipments/ShipmentList.vue'), meta: { title: '发货管理', menu: true, icon: '🚚' } },
      { path: 'shipments/:id', name: 'ShipmentDetail', component: () => import('../views/shipments/ShipmentDetail.vue'), meta: { title: '发货单详情' } },
      { path: 'freight', name: 'FreightList', component: () => import('../views/freight/FreightList.vue'), meta: { title: '货代单据', menu: true, icon: '📦' } },
      { path: 'freight-addresses', name: 'FreightAddressList', component: () => import('../views/addresses/AddressList.vue'), meta: { title: '货代地址维护', menu: true, icon: '📍', addressType: 'freight' } },
      { path: 'addresses', name: 'AddressList', component: () => import('../views/addresses/AddressList.vue'), meta: { title: '地址管理', icon: '📍' } },
