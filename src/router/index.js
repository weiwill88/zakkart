...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'products', name: 'ProductList', component: () => import('../views/products/ProductList.vue'), meta: { title: '产品管理' } },
      ...
      { path: 'orders', name: 'OrderGenerator', component: () => import('../views/orders/OrderGenerator.vue'), meta: { title: '订单生成', menu: true, icon: '📝' } },
      { path: 'contracts', name: 'ContractList', component: () => import('../views/system/ComingSoonView.vue'), meta: { title: '合同管理', menu: true, icon: '📄', phase: '阶段 2', description: '合同列表、合同详情、归档上传会在阶段 2 与订单生成联动完成。' } },
      { path: 'quality', name: 'QualityList', component: () => import('../views/system/ComingSoonView.vue'), meta: { title: '质检管理', menu: true, icon: '🔎', phase: '阶段 3', description: '质检管理会在状态机和验货流程阶段正式落地。' } },
      ...
      { path: 'addresses', name: 'AddressList', component: () => import('../views/system/ComingSoonView.vue'), meta: { title: '地址管理', menu: true, icon: '📍', phase: '阶段 1', description: '地址 CRUD 会与供应商详情表单一起接入正式数据。' } },
      { path: 'inventory', name: 'Inventory', component: () => import('../views/inventory/InventoryOverview.vue'), meta: { title: '库存管理', menu: true, icon: '📊' } },
